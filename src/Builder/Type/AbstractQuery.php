...
use Somnambulist\Components\QueryBuilder\Builder\JoinType;
 ...
 */
abstract class AbstractQuery implements ExpressionInterface
{
    protected ValueBinder $valueBinder;
    protected FunctionsBuilder $functionsBuilder;
    ...
    public function __construct(?ValueBinder $valueBinder = null, ?FunctionsBuilder $functionsBuilder = null, ?TypeMap $typeMap = null)
    {
        $this->valueBinder = $valueBinder ?? new ValueBinder();
        $this->functionsBuilder = $functionsBuilder ?? new FunctionsBuilder();
     ...
     * @return $this
     */
    public function leftJoin(ExpressionInterface|string $table, string $as = '', ExpressionInterface|Closure|array|string $on = [], array $types = []): self
    {
     ...
     * @return $this
     */
    public function rightJoin(ExpressionInterface|string $table, string $as = '', ExpressionInterface|Closure|array|string $on = [], array $types = []): self
    {
     ...
     * @return $this
     */
    public function innerJoin(ExpressionInterface|string $table, string $as = '', ExpressionInterface|Closure|array|string $on = [], array $types = []): self
    {
    ...
    public function resetClause(string ...$name): self
    {
        foreach ($name as $n) {
    ...
    public function setValueBinder(ValueBinder $binder): self
    {
